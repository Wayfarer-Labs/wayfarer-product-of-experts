...
from experts import GenerativeExpert_Axis, DiscriminativeExpert_Color, GenerativeExpert_Color, DiscriminativeExpert_Ellipsoid
...
for expert in tqdm((expert_x, expert_y, expert_z, expert_all, expert_rgb), desc='Loading experts'):
...
for expert in tqdm((expert_rgb,), desc='Visualizing generative experts'):
    continue # testing 
